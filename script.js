...
function runqueary(quaryurl){
    $.ajax({
        ...
        $(".weather").append("<h2>"+weatherdata.name+"</h2>");
        $(".weather").append("<h2>"+weatherdata.main.temp+"</h2>");
        $(".weather").append("<h2>"+weatherdata.main.humidity+"</h2>");
        $(".weather").append("<h2>"+weatherdata.wind.speed+"</h2>");
...
.done(function(forecastdata){
    $(".weather").append("<h2>"+forecastdata[0].futureeweather+"</h2>")
